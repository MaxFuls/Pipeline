...
import (
	...
	"log/slog"
	"net"
	process_server "process_handler/internal/grpc/process"
	process_service "process_handler/internal/service/process"
...
func New(name string, ip string, port uint32, log *slog.Logger, regIp string, regPort uint32) *App {
	gRPC := grpc.NewServer()
	process_server.RegisterServer(gRPC, process_service.New("default"))
