...
func (x *RegistryRequest) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *GetResponse) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
const file_registry_registry_proto_rawDesc = "" +
	...
	"\x02ip\x18\x02 \x01(\tR\x02ip\x12\x12\n" +
	"\x04port\x18\x03 \x01(\rR\x04port2\x85\x01\n" +
	"\bRegistry\x12C\n" +
	"\bRegister\x12\x19.registry.RegistryRequest\x1a\x1a.registry.RegistryResponse\"\x00\x124\n" +
	"\x03Get\x12\x14.registry.GetRequest\x1a\x15.registry.GetResponse\"\x00B\x1eZ\x1cmaxfuls.registry.v1;registryb\x06proto3"
